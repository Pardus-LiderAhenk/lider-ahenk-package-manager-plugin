...
public class AddRemovePackageLoadingDialog extends Dialog {

	private Label message;
	private ProgressBar progBar;

	public AddRemovePackageLoadingDialog(Shell parentShell) {
		super(parentShell);
	...
	protected Control createContents(Composite parent) {
		...
		message.setText(Messages.getString("ON_PROCESS_LOADING_MESSAGE"));
