...
public class PackageManagementLoadingDialog extends Dialog {

	private Label message;
	private ProgressBar progBar;

	public PackageManagementLoadingDialog(Shell parentShell) {
		super(parentShell);
	...
	protected Control createContents(Composite parent) {
		...
		message.setText(Messages.getString("LOADING"));
